...
NOTE: This module is a facade that re-exports from core/ for backward compatibility.
Most dataclasses and functions are now defined in core/params.py and core/economics.py.
"""
