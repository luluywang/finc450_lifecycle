...
.. deprecated::
    This module is deprecated in favor of the `visualization` module.
...
# These functions are unique to retirement_simulation.py
...
warnings.warn(
    "The visualizations module is deprecated. "
    "Use `from visualization import ...` for all plotting functions.",
    DeprecationWarning,
    stacklevel=2
)

# Re-export from visualization module for backward compatibility
from visualization import (
    COLORS as VIZ_COLORS,
    STRATEGY_COLORS,
    plot_duration_matching_intuition as _plot_duration_matching_intuition,
    plot_strategy_comparison_bars as _plot_strategy_comparison_bars,
    plot_wealth_paths_spaghetti as _plot_wealth_paths_spaghetti,
    plot_final_wealth_distribution as _plot_final_wealth_distribution,
)
