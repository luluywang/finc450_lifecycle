...
\begin{center}
\includegraphics[width=0.85\textwidth]{../output/figures/01_income_expenses.png}
\end{center}
\end{frame}

\begin{frame}{The Cash Flow Pattern}
\begin{center}
\includegraphics[width=0.85\textwidth]{../output/figures/02_cash_flow.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{../output/figures/03_present_values.png}
\end{center}
\end{frame}

\begin{frame}{Human Capital is Your Biggest Asset (Early On)}
\begin{center}
\includegraphics[width=0.85\textwidth]{../output/figures/04_wealth_composition.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{../output/figures/05_gauges_dashboard.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{../output/figures/06_allocation_theory.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{../output/figures/09_beta_comparison.png}
\end{center}
\end{frame}

\begin{frame}{Detailed View: Risky Human Capital ($\beta = 0.2$)}
\begin{center}
\includegraphics[width=0.95\textwidth]{../output/figures/10_allocation_risky_hc.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{../output/figures/07_duration_matching.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{../output/figures/08_consumption_path.png}
\end{center}
